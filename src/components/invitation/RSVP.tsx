    ...
    <section className="py-32 px-6 bg-background relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-serif mb-8">Confirm Attendance</h2>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-white rounded-[4rem] p-10 md:p-20 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-primary/5 border-t-[20px] border-t-primary/20"
        >
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
              ...
              <div className="pt-8">
                <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white font-serif py-12 rounded-[2rem] shadow-2xl transition-all hover:translate-y-[-4px] active:translate-y-0 text-3xl group relative overflow-hidden">
