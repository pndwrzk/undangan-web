      ...
      <section className="mb-12">
        <div className="flex justify-between items-center mb-10">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            />
            <DialogContent className="sm:max-w-[800px] rounded-[3rem] border-primary/10 max-h-[90vh] overflow-y-auto pr-2 scrollbar-hide">
              <DialogHeader>
              ...
              <form ref={formRef} onSubmit={handleUpdateCouple} className="grid grid-cols-1 md:grid-cols-2 gap-8 py-6">
                ...
                <div className="md:col-span-2 space-y-6 pt-4">
                  <h3 className="text-sm font-typewriter uppercase tracking-widest text-muted-foreground border-b border-muted/20 pb-2">Global Settings</h3>
